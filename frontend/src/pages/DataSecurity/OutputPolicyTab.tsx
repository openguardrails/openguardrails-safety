...
const OutputPolicyTab: React.FC = () => {
  ...
  const fetchPolicy = async () => {
    ...
    try {
      ...
      setPolicy(data)
      form.reset({
        output_high_risk_anonymize: data.output_high_risk_anonymize_override,
        output_medium_risk_anonymize: data.output_medium_risk_anonymize_override,
        output_low_risk_anonymize: data.output_low_risk_anonymize_override,
      })
    } catch (error: any) {
...
export default OutputPolicyTab
